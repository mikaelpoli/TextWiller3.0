#' Estrazione di regular expression (e quindi user, hashtag) e shorturl
#' 
#' \code{patternExtract} Estrae i pattern contenuti in \code{testo}.
...
#' (default) estrae i riferimenti ad uno user nei tweet. \code{"#\\w+"} estrae
#' gli hashtag.
#' @param id Se \code{testo} e' un vettore con nomi, questi vengono presi come
#' id. In caso contrario, gli id sono numeri progressivi da 1 a \code{length(testo)}.-
#' @return \code{patternExtract} restituisce un \code{data.frame} con
#' colonne: id, pattern. \code{urlExtract} restituisce un \code{data.frame} con colonne: id, shorturl, url.
#' @note %% ~~further notes~~
